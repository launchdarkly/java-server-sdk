...
public enum LDCountryCode
{
  ...
  private LDCountryCode(String name, String alpha3, int numeric, Assignment assignment)
  {
    this.name = name;
    this.alpha3 = alpha3;
   ...
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#CA CountryCode.CA}</td>
   *   <td>{@link Locale#CANADA}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#CN CountryCode.CN}</td>
   *   <td>{@link Locale#CHINA}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#DE CountryCode.DE}</td>
   *   <td>{@link Locale#GERMANY}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#FR CountryCode.FR}</td>
   *   <td>{@link Locale#FRANCE}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#GB CountryCode.GB}</td>
   *   <td>{@link Locale#UK}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#IT CountryCode.IT}</td>
   *   <td>{@link Locale#ITALY}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#JP CountryCode.JP}</td>
   *   <td>{@link Locale#JAPAN}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#KR CountryCode.KR}</td>
   *   <td>{@link Locale#KOREA}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#TW CountryCode.TW}</td>
   *   <td>{@link Locale#TAIWAN}</td>
   * </tr>
   * <tr>
   *   <td>{@link LDCountryCode#US CountryCode.US}</td>
   ...
   */
  public static LDCountryCode getByCode(String code)
  {
   ...
   * @see #getByCode(String, boolean)
   */
  public static LDCountryCode getByCodeIgnoreCase(String code)
  {
   ...
   *         A {@code CountryCode} instance, or {@code null} if not found.
   */
  public static LDCountryCode getByCode(String code, boolean caseSensitive)
  {
    if (code == null)
    {
      return null;
  ...
  private static LDCountryCode getByAlpha2Code(String code)
  {
    try
    {
      return Enum.valueOf(LDCountryCode.class, code);
    }
    catch (IllegalArgumentException e)
    {
      return null;
  ...
  private static LDCountryCode getByAlpha3Code(String code)
  {
   ...
   * @since 1.11
   */
  public static List<LDCountryCode> findByName(String regex)
  {
    if (regex == null)
    {
