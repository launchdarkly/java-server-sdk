 ...
 */
public final class TestHttpCertificates {
  ...
  public static final class Builder {
    ...
    private TestHttpCertificates issuedBy;
     ...
     * generated.
     */
    public Builder issuedBy(TestHttpCertificates signedBy) {
    ...
    public TestHttpCertificates build() throws GeneralSecurityException {
      ...
      generator.addExtension(X509Extensions.SubjectKeyIdentifier, true, new SubjectKeyIdentifier("z".getBytes()));
      generator.addExtension(X509Extensions.AuthorityKeyIdentifier, true, new AuthorityKeyIdentifier("x".getBytes()));
      ...
      return new TestHttpCertificates(certificate, heldKeyPair);
    }
