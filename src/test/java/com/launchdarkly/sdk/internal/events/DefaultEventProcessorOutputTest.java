...
//  private static final int FLAG_VERSION = 11;
//  private static final EvaluationDetail<LDValue> SOME_RESULT = EvaluationDetail.fromValue(
//      LDValue.of("value"), 1, EvaluationReason.off());
//  
...
//    MockEventSender es = new MockEventSender();
//    Event.FeatureRequest fe = makeFeatureRequestEvent(FLAG_KEY, user, FLAG_VERSION,
//        SOME_RESULT, LDValue.ofNull());
//
...
//        isFeatureEvent(fe, FLAG_KEY, FLAG_VERSION, false, null),
//        isSummaryEvent()
//    ));
//  }
//
